...
# HOTFIX-20251001-001: Router re-enabled with QuoteListPresenter for data processing
...
# === RUTAS PARA VISUALIZACIÓN DE COTIZACIONES ===
# HOTFIX-20251001-001: Duplicate /quotes route removed - handled by quotes router
# Data processing logic moved to app/presenters/quote_presenter.py
